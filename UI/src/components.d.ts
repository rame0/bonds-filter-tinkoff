...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    PortfolioCouponCell: typeof import('./components/PortfolioCouponCell.vue')['default']
    PortfolioCouponChart: typeof import('./components/PortfolioCouponChart.vue')['default']
    PortfolioCouponMonths: typeof import('./components/PortfolioCouponMonths.vue')['default']
