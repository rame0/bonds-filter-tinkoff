...
import {
  ...
  OrderDirection,
  CandleInterval
} from '@/data/Interfaces/common'
import { getCommonPart } from '@/utils/string'
...
type Enums = CandleInterval | OrderDirection | SecurityTradingStatus

// todo: можно ли сделать более лаконично?
type getEnumType<T extends Enums> = T extends CandleInterval
  ? typeof CandleInterval
  : T extends OrderDirection
